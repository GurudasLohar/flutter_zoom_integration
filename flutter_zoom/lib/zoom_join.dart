...
/*            Padding(
  ...
  joinMeeting(BuildContext context) {
    ...
    if (meetingIdController.text.isNotEmpty &&
      ...
      ZoomOptions zoomOptions = ZoomOptions(
        domain: "zoom.us",
        appKey: "sVffJNEReouS9SwYUP9rpLHCXUasXgjOyqKK", //API KEY FROM ZOOM
        appSecret:
            "kClYQkxe5d1blj3Gh2swAyuTpN3TEEsTCctN", //API SECRET FROM ZOOM
      );
  ...
  startMeeting(BuildContext context) {
    ...
    ZoomOptions zoomOptions = ZoomOptions(
      domain: "zoom.us",
      appKey:
          "sVffJNEReouS9SwYUP9rpLHCXUasXgjOyqKK", //API KEY FROM ZOOM -- SDK KEY
      appSecret:
          "kClYQkxe5d1blj3Gh2swAyuTpN3TEEsTCctN", //API SECRET FROM ZOOM -- SDK SECRET
    );
    var meetingOptions = ZoomMeetingOptions(
